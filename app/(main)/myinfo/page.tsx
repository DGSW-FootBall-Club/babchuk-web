      ...
      <div className="flex flex-col md:flex-row flex-1 p-4 gap-4">
        <div className="md:w-115 shrink-0 bg-white rounded-2xl p-6 flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <p className="text-xl font-bold text-[#191F28]">{user.nickname}</p>
            </div>
            <button className="text-sm font-medium text-[#4B5563] border border-[#E5E8EB] px-3 py-1.5 rounded-lg">
              프로필 수정
            </button>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-[#F8F9FB] rounded-xl p-4">
              <p className="text-xs text-[#8B95A1] mb-1">성별</p>
              <p className="text-base font-bold text-[#191F28]">
                {GenderTypeLabel[user.gender]}
              </p>
            </div>
            <div className="bg-[#F8F9FB] rounded-xl p-4">
              <p className="text-xs text-[#8B95A1] mb-1">축구 실력</p>
              <p className="text-base font-bold text-[#191F28]">
          ...
          <div className="bg-primary rounded-xl p-5">
            ...
            <p className="text-2xl font-bold text-white">{user.grade}학번</p>
          </div>
        ...
        <div className="flex-1 flex flex-col gap-3">
          ...
          <div className="bg-white rounded-2xl overflow-hidden">
            <p className="text-xs font-semibold text-[#8B95A1] px-5 pt-5 pb-2">고객센터</p>
            {menuItems.map((item, index) => (
              ...
              >
                <p className="text-base text-[#191F28]">{item.label}</p>
