      ...
      <div className="flex flex-col md:flex-row flex-1 px-4 md:px-5 pb-4 gap-4">
        <div className="md:w-115 shrink-0 bg-white rounded-full p-6 flex flex-col gap-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-sm font-medium text-[#4B5563] border border-[#E5E8EB] px-3 py-1.5 rounded-lg active:scale-95 transition-all"
            >
              프로필 수정
            </button>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-[#F8F9FB] rounded-xl p-4">
              <p className="text-xs text-[#8B95A1] mb-1.5">성별</p>
            ...
            <div className="bg-[#F8F9FB] rounded-xl p-4">
              <p className="text-xs text-[#8B95A1] mb-1.5">축구 실력</p>
              <div className="flex items-center gap-2">
                <img
                  src={
        ...
        <div className="flex-1 flex flex-col gap-3">
          <div className="bg-white rounded-2xl overflow-hidden">
            <p className="text-xs font-semibold text-[#8B95A1] px-5 pt-5 pb-2">
              고객센터
            </p>
