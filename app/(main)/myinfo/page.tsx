      ...
      <div className="flex flex-col md:flex-row flex-1 p-4 gap-4">
        <div className="md:w-115 shrink-0 bg-white rounded-2xl p-6 flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <p className="text-xl font-bold font-pretendard text-[#191F28]">{user.nickname}</p>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-[#F8F9FB] rounded-xl p-4">
              <p className="text-xs text-[#8B95A1] font-pretendard mb-1">성별</p>
              <p className="text-base font-bold font-pretendard text-[#191F28]">
                {GenderTypeLabel[user.gender]}
              </p>
            </div>
            <div className="bg-[#F8F9FB] rounded-xl p-4">
              <p className="text-xs text-[#8B95A1] font-pretendard mb-1">축구 실력</p>
              <p className="text-base font-bold font-pretendard text-[#191F28]">
          ...
          <div className="bg-primary rounded-xl p-5">
            <p className="text-xs text-white/70 font-pretendard mb-1">학번</p>
        ...
        <div className="flex-1 flex flex-col gap-3">
          ...
          <div className="bg-white rounded-2xl overflow-hidden">
            <p className="text-xs font-semibold text-[#8B95A1] font-pretendard px-5 pt-5 pb-2">고객센터</p>
